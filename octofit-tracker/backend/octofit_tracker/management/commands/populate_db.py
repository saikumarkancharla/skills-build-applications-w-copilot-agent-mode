...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create team members explicitly
        team1 = Team(_id=ObjectId(), name='Blue Team')
        team2 = Team(_id=ObjectId(), name='Gold Team')
        team1.save()
        team2.save()

        TeamMember.objects.create(team=team1, user=users[0])
        TeamMember.objects.create(team=team1, user=users[1])
        TeamMember.objects.create(team=team2, user=users[2])
        TeamMember.objects.create(team=team2, user=users[3])
        TeamMember.objects.create(team=team2, user=users[4])
